            ...
            <div class="bottom">
                ...
                <div class="progress-wrapper">
                    ...
                    <div class="progress-bar-wrapper">
                        <progress-bar :percent="percent" @percentChange="onProcessChange"></progress-bar>
                    </div>
...
export default {
  ...
  methods: {
    ...
    format(timestamp) {
      ...
      const seconds = this._pad(timestamp % 60)
    ...
    _pad(num, n = 2) {
      ...
      const diff = n - len
      if (diff > 0) {
        return Array.apply(null, Array(diff)).map(i => 0).join('') + num
      }
      return num + ''
    },
    _getPosAndScale() {
